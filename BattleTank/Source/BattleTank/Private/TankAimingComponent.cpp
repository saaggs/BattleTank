...
void UTankAimingComponent::MoveBarrelTowards(FVector AimDirection)
{
	...
	Barrel->Elevate(DeltaRotator.Pitch);  // replaced magic number here!
	Turret->TurretRotation(DeltaRotator.Yaw);
}

/* // You didn't need this, only needed to use the function above and set two of the variables instead of one.
